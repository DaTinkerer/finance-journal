    ...
    <div class="register">
      ...
      <div class="form">
        ...
        <form @submit.prevent="signUpForm" class="login-form">
          ...
          <input v-model="email" type="email" name="eamil" class="form-inputs">
          </div>
          </div>
          ...
          <input v-model="password1" type="password" name="password" class="form-inputs">
          </div>
          </div>
          ...
          <div>
          <input v-model="password2" type="password" name="password2" class="form-inputs">
          </div>
          </div>
